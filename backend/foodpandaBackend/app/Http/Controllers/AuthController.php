...
class AuthController extends Controller
{
    ...
    {
        $token = $request->token;
        $originalRedirect = $request->redirect_url;
        $unauthenticatedRedirect = 'https://frontend.example.com/unauthenticated';
        //   $user = JWTAuth::parseToken()->authenticate();
        ...
        try {
            ...
            return response()->json([
                ...
                'redirect_url' => $unauthenticatedRedirect
            ], 500);
        }
    }
}
